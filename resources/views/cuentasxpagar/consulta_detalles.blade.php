...
@section('content')
    <div class="row">
        ...
        <div class="col-xs-1 col-sm-1 col-md-1 col-lg-1 ">
            <small><a href="{{route('abonodatos_ctaxpagar',$facturas[0]->proveedor_id)}}" class="btn btn-warning glyphicon glyphicon glyphicon-usd btn-sm" title="Ir a pagos"></a></small>
        </div>
    </div>
    <hr/>
    <div class="row">
